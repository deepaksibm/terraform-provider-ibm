...
var _ = Describe(`VpcV1 Examples Tests`, func() {
	...
	Describe(`VpcV1 request examples`, func() {
		...
		It(`ListVPCAddressPrefixes request example`, func() {
			...
			listVPCAddressPrefixesOptions.SetSort("name")
		...
		It(`ListVPCRoutes request example`, func() {
			...
			listVPCRoutesOptions.SetSort("name")
		...
		It(`ListVPCRoutingTables request example`, func() {
			...
			listVPCRoutingTablesOptions.SetSort("name")
		...
		It(`ListVPCRoutingTableRoutes request example`, func() {
			...
			listVPCRoutingTableRoutesOptions.SetSort("name")
		...
		It(`ListSubnets request example`, func() {
			...
			listSubnetsOptions.SetSort("name")
		...
		It(`ListImages request example`, func() {
			...
			listImagesOptions.SetSort("name")
		...
		It(`ListOperatingSystems request example`, func() {
			...
			listOperatingSystemsOptions.SetSort("name")
		...
		It(`ListInstanceProfiles request example`, func() {
			...
			listInstanceProfilesOptions.SetSort("name")
		...
		It(`ListInstances request example`, func() {
			...
			listInstancesOptions.SetSort("name")
		...
		It(`AddInstanceNetworkInterfaceIP request example`, func() {
			fmt.Println("\nAddInstanceNetworkInterfaceIP() result:")
			// begin-add_instance_network_interface_ip

			addInstanceNetworkInterfaceIPOptions := vpcService.NewAddInstanceNetworkInterfaceIPOptions(
				"testString",
				"testString",
				"testString",
			)
			...
			// end-add_instance_network_interface_ip
		...
		It(`ListInstanceGroups request example`, func() {
			...
			listInstanceGroupsOptions.SetSort("name")
		...
		It(`ListInstanceGroupManagers request example`, func() {
			...
			listInstanceGroupManagersOptions.SetSort("name")
		...
		It(`ListInstanceGroupManagerActions request example`, func() {
			...
			listInstanceGroupManagerActionsOptions.SetSort("name")
		...
		It(`ListInstanceGroupManagerPolicies request example`, func() {
			...
			listInstanceGroupManagerPoliciesOptions.SetSort("name")
		...
		It(`ListInstanceGroupMemberships request example`, func() {
			...
			listInstanceGroupMembershipsOptions.SetSort("name")
		...
		It(`ListDedicatedHostGroups request example`, func() {
			...
			listDedicatedHostGroupsOptions.SetSort("name")
		...
		It(`ListDedicatedHosts request example`, func() {
			...
			listDedicatedHostsOptions.SetSort("name")
		...
		It(`ListBareMetalServerProfiles request example`, func() {
			...
			listBareMetalServerProfilesOptions.SetSort("name")
		...
		It(`ListBareMetalServerNetworkInterfaceIps request example`, func() {
			fmt.Println("\nListBareMetalServerNetworkInterfaceIps() result:")
			// begin-list_bare_metal_server_network_interface_ips

			listBareMetalServerNetworkInterfaceIpsOptions := vpcService.NewListBareMetalServerNetworkInterfaceIpsOptions(
				"testString",
				"testString",
			)
		...
		It(`GetBareMetalServerNetworkInterfaceIP request example`, func() {
			fmt.Println("\nGetBareMetalServerNetworkInterfaceIP() result:")
			// begin-get_bare_metal_server_network_interface_ip

			getBareMetalServerNetworkInterfaceIPOptions := vpcService.NewGetBareMetalServerNetworkInterfaceIPOptions(
				"testString",
				"testString",
				"testString",
			)
		...
		It(`AddBareMetalServerNetworkInterfaceIP request example`, func() {
			fmt.Println("\nAddBareMetalServerNetworkInterfaceIP() result:")
			// begin-add_bare_metal_server_network_interface_ip

			addBareMetalServerNetworkInterfaceIPOptions := vpcService.NewAddBareMetalServerNetworkInterfaceIPOptions(
				"testString",
				"testString",
				"testString",
			)
			...
			// end-add_bare_metal_server_network_interface_ip
		...
		It(`ReplaceBareMetalServerInitialization request example`, func() {
			fmt.Println("\nReplaceBareMetalServerInitialization() result:")
			// begin-replace_bare_metal_server_initialization
			...
			replaceBareMetalServerInitializationOptions := vpcService.NewReplaceBareMetalServerInitializationOptions(
				"testString",
				imageIdentityModel,
				[]vpcv1.KeyIdentityIntf{keyIdentityModel},
			)
			...
			// end-replace_bare_metal_server_initialization
		...
		It(`ListVolumeProfiles request example`, func() {
			...
			listVolumeProfilesOptions.SetSort("name")
		...
		It(`ListVolumes request example`, func() {
			...
			listVolumesOptions.SetSort("name")
		...
		It(`ListPublicGateways request example`, func() {
			...
			listPublicGatewaysOptions.SetSort("name")
		...
		It(`ListFloatingIps request example`, func() {
			...
			listFloatingIpsOptions.SetSort("name")
		...
		It(`ListNetworkAcls request example`, func() {
			...
			listNetworkAclsOptions.SetSort("name")
		...
		It(`ListNetworkACLRules request example`, func() {
			...
			listNetworkACLRulesOptions.SetSort("name")
		...
		It(`ListSecurityGroups request example`, func() {
			...
			listSecurityGroupsOptions.SetSort("name")
		...
		It(`ListSecurityGroupNetworkInterfaces request example`, func() {
			...
			listSecurityGroupNetworkInterfacesOptions.SetSort("name")
		...
		It(`ListSecurityGroupTargets request example`, func() {
			...
			listSecurityGroupTargetsOptions.SetSort("name")
		...
		It(`ListIkePolicies request example`, func() {
			...
			listIkePoliciesOptions.SetSort("name")
		...
		It(`ListIpsecPolicies request example`, func() {
			...
			listIpsecPoliciesOptions.SetSort("name")
		...
		It(`ListLoadBalancers request example`, func() {
			...
			listLoadBalancersOptions.SetSort("name")
		...
		It(`ListLoadBalancerPoolMembers request example`, func() {
			...
			listLoadBalancerPoolMembersOptions.SetSort("name")
		...
		It(`ListEndpointGateways request example`, func() {
			...
			listEndpointGatewaysOptions.SetSort("name")
		...
		It(`ListFlowLogCollectors request example`, func() {
			...
			listFlowLogCollectorsOptions.SetSort("name")
		...
		It(`RemoveInstanceNetworkInterfaceIP request example`, func() {
			// begin-remove_instance_network_interface_ip

			removeInstanceNetworkInterfaceIPOptions := vpcService.NewRemoveInstanceNetworkInterfaceIPOptions(
				"testString",
				"testString",
				"testString",
			)
			...
			// end-remove_instance_network_interface_ip
			fmt.Printf("\nRemoveInstanceNetworkInterfaceIP() response status code: %d\n", response.StatusCode)
		...
		It(`RemoveBareMetalServerNetworkInterfaceIP request example`, func() {
			// begin-remove_bare_metal_server_network_interface_ip

			removeBareMetalServerNetworkInterfaceIPOptions := vpcService.NewRemoveBareMetalServerNetworkInterfaceIPOptions(
				"testString",
				"testString",
				"testString",
			)
			...
			// end-remove_bare_metal_server_network_interface_ip
			fmt.Printf("\nRemoveBareMetalServerNetworkInterfaceIP() response status code: %d\n", response.StatusCode)
