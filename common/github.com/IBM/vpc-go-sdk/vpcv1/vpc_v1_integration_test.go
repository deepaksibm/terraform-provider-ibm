...
var _ = Describe(`VpcV1 Integration Tests`, func() {
	...
	Describe(`Client initialization`, func() {
		...
		It("Successfully construct the service client instance", func() {
			...
			vpcServiceOptions := &vpcv1.VpcV1Options{
				...
				Generation: core.Int64Ptr(int64(1)),
			}
	...
	Describe(`CreateVPCRoutingTable - Create a routing table for a VPC`, func() {
		...
		It(`CreateVPCRoutingTable(createVPCRoutingTableOptions *CreateVPCRoutingTableOptions)`, func() {
			...
			resourceFilterModel := &vpcv1.ResourceFilter{
				CRN:          core.StringPtr("crn:v1:bluemix:public:is:us-south-1:a/123456::vpn:02e7-036564c8-3e04-4801-a13a-2082b52db2db"),
				Href:         core.StringPtr("https://us-south.iaas.cloud.ibm.com/v1/vpn_gateways/02e7-036564c8-3e04-4801-a13a-2082b52db2db"),
				ID:           core.StringPtr("02e7-036564c8-3e04-4801-a13a-2082b52db2db"),
	...
	Describe(`ListSubnets - List all subnets`, func() {
		...
		It(`ListSubnets(listSubnetsOptions *ListSubnetsOptions)`, func() {
			...
			listSubnetsOptions := &vpcv1.ListSubnetsOptions{
				...
				NetworkACLCRN:    core.StringPtr("testString"),
				NetworkACLName:   core.StringPtr("testString"),
				RoutingTableID:   core.StringPtr("testString"),
	...
	Describe(`CreateSubnetReservedIP - Reserve an IP in a subnet`, func() {
		...
		It(`CreateSubnetReservedIP(createSubnetReservedIPOptions *CreateSubnetReservedIPOptions)`, func() {
			...
			reservedIPFloatingIPPrototypeModel := &vpcv1.ReservedIPFloatingIPPrototypeFloatingIPIdentityFloatingIPIdentityByID{
			...
			createSubnetReservedIPOptions := &vpcv1.CreateSubnetReservedIPOptions{
				...
				FloatingIP: reservedIPFloatingIPPrototypeModel,
	...
	Describe(`CreateImage - Create an image`, func() {
		...
		It(`CreateImage(createImageOptions *CreateImageOptions)`, func() {
			...
			imageFileChecksumsModel := &vpcv1.ImageFileChecksums{
				Sha256: core.StringPtr("e992a84f113d3a35d2145ca3e7aca4fc95fe6daf470a08d8af3422ee59c92e15"),
			}

			imageFilePrototypeModel := &vpcv1.ImageFilePrototype{
				Checksums: imageFileChecksumsModel,
	...
	Describe(`CreateInstanceTemplate - Create an instance template`, func() {
		...
		It(`CreateInstanceTemplate(createInstanceTemplateOptions *CreateInstanceTemplateOptions)`, func() {
			...
			instanceAvailabilityPrototypeModel := &vpcv1.InstanceAvailabilityPrototype{
				...
				HostMaintenance: core.StringPtr("live_migrate"),
			}
	...
	Describe(`AddInstanceNetworkInterfaceIP - Bind a reserved IP to a network interface`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`AddInstanceNetworkInterfaceIP(addInstanceNetworkInterfaceIPOptions *AddInstanceNetworkInterfaceIPOptions)`, func() {

			addInstanceNetworkInterfaceIPOptions := &vpcv1.AddInstanceNetworkInterfaceIPOptions{
				InstanceID:         core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				ID:                 core.StringPtr("testString"),
			}

			reservedIP, response, err := vpcService.AddInstanceNetworkInterfaceIP(addInstanceNetworkInterfaceIPOptions)
	...
	Describe(`UpdateInstanceGroupMembership - Update an instance group membership`, func() {
		...
		It(`UpdateInstanceGroupMembership(updateInstanceGroupMembershipOptions *UpdateInstanceGroupMembershipOptions)`, func() {
			...
			instanceGroupMembershipPatchModel := &vpcv1.InstanceGroupMembershipPatch{
				DeleteInstanceOnMembershipDelete: core.BoolPtr(true),
	...
	Describe(`CreateBackupPolicyPlan - Create a plan for a backup policy`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`CreateBackupPolicyPlan(createBackupPolicyPlanOptions *CreateBackupPolicyPlanOptions)`, func() {
	...
	Describe(`CreatePlacementGroup - Create a placement group`, func() {
		...
		It(`CreatePlacementGroup(createPlacementGroupOptions *CreatePlacementGroupOptions)`, func() {
			...
			dedicatedHostGroupIdentityModel := &vpcv1.DedicatedHostGroupIdentityByID{
				ID: core.StringPtr("bcc5b834-1258-4b9c-c3b4-43bc9cf5cde0"),
			}
			...
			createPlacementGroupOptions := &vpcv1.CreatePlacementGroupOptions{
				...
				DedicatedHostGroup: dedicatedHostGroupIdentityModel,
	...
	Describe(`CreateBareMetalServer - Create a bare metal server`, func() {
		...
		It(`CreateBareMetalServer(createBareMetalServerOptions *CreateBareMetalServerOptions)`, func() {
			...
			bareMetalServerCpuPrototypeModel := &vpcv1.BareMetalServerCpuPrototype{
				CoreCount:      core.Int64Ptr(int64(80)),
				ThreadsPerCore: core.Int64Ptr(int64(2)),
			}
			...
			createBareMetalServerOptions := &vpcv1.CreateBareMetalServerOptions{
				...
				Zone:                    zoneIdentityModel,
				Cpu:                     bareMetalServerCpuPrototypeModel,
				EnableSecureBoot:        core.BoolPtr(false),
				Memory:                  core.Int64Ptr(int64(1536)),
	...
	Describe(`ListBareMetalServerNetworkInterfaceIps - List all reserved IPs bound to a network interface`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`ListBareMetalServerNetworkInterfaceIps(listBareMetalServerNetworkInterfaceIpsOptions *ListBareMetalServerNetworkInterfaceIpsOptions)`, func() {

			listBareMetalServerNetworkInterfaceIpsOptions := &vpcv1.ListBareMetalServerNetworkInterfaceIpsOptions{
				BareMetalServerID:  core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				Name:               core.StringPtr("testString"),
			}

			reservedIPCollectionNetworkInterfaceContext, response, err := vpcService.ListBareMetalServerNetworkInterfaceIps(listBareMetalServerNetworkInterfaceIpsOptions)
	...
	Describe(`GetBareMetalServerNetworkInterfaceIP - Retrieve bound reserved IP`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`GetBareMetalServerNetworkInterfaceIP(getBareMetalServerNetworkInterfaceIPOptions *GetBareMetalServerNetworkInterfaceIPOptions)`, func() {

			getBareMetalServerNetworkInterfaceIPOptions := &vpcv1.GetBareMetalServerNetworkInterfaceIPOptions{
				BareMetalServerID:  core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				ID:                 core.StringPtr("testString"),
			}

			reservedIP, response, err := vpcService.GetBareMetalServerNetworkInterfaceIP(getBareMetalServerNetworkInterfaceIPOptions)
	...
	Describe(`AddBareMetalServerNetworkInterfaceIP - Bind a reserved IP to a network interface`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`AddBareMetalServerNetworkInterfaceIP(addBareMetalServerNetworkInterfaceIPOptions *AddBareMetalServerNetworkInterfaceIPOptions)`, func() {

			addBareMetalServerNetworkInterfaceIPOptions := &vpcv1.AddBareMetalServerNetworkInterfaceIPOptions{
				BareMetalServerID:  core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				ID:                 core.StringPtr("testString"),
			}

			reservedIP, response, err := vpcService.AddBareMetalServerNetworkInterfaceIP(addBareMetalServerNetworkInterfaceIPOptions)
	...
	Describe(`ReplaceBareMetalServerInitialization - Reinitialize a bare metal server`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`ReplaceBareMetalServerInitialization(replaceBareMetalServerInitializationOptions *ReplaceBareMetalServerInitializationOptions)`, func() {
			...
			replaceBareMetalServerInitializationOptions := &vpcv1.ReplaceBareMetalServerInitializationOptions{
				ID:       core.StringPtr("testString"),
				Image:    imageIdentityModel,
				Keys:     []vpcv1.KeyIdentityIntf{keyIdentityModel},
				UserData: core.StringPtr("testString"),
			...
			bareMetalServerInitialization, response, err := vpcService.ReplaceBareMetalServerInitialization(replaceBareMetalServerInitializationOptions)
	...
	Describe(`UpdateFloatingIP - Update a floating IP`, func() {
		...
		It(`UpdateFloatingIP(updateFloatingIPOptions *UpdateFloatingIPOptions)`, func() {
			...
			floatingIPPatchTargetReservedIPIdentityModel := &vpcv1.FloatingIPPatchTargetReservedIPIdentityReservedIPIdentityByID{
				ID: core.StringPtr("69e55145-cc7d-4d8e-9e1f-cc3fb60b1793"),
			}

			floatingIPPatchModel := &vpcv1.FloatingIPPatch{
				Name:   core.StringPtr("my-floating-ip"),
				Target: floatingIPPatchTargetReservedIPIdentityModel,
			}
	...
	Describe(`CreateLoadBalancer - Create a load balancer`, func() {
		...
		It(`CreateLoadBalancer(createLoadBalancerOptions *CreateLoadBalancerOptions)`, func() {
			...
			loadBalancerPoolSessionPersistencePrototypeModel := &vpcv1.LoadBalancerPoolSessionPersistencePrototype{
				CookieName: core.StringPtr("testString"),
	...
	Describe(`CreateEndpointGateway - Create an endpoint gateway`, func() {
		...
		It(`CreateEndpointGateway(createEndpointGatewayOptions *CreateEndpointGatewayOptions)`, func() {
			...
			endpointGatewayReservedIPModel := &vpcv1.EndpointGatewayReservedIPReservedIPIdentityReservedIPIdentityReservedIPIdentityByID{
	...
	Describe(`CreateFlowLogCollector - Create a flow log collector`, func() {
		...
		It(`CreateFlowLogCollector(createFlowLogCollectorOptions *CreateFlowLogCollectorOptions)`, func() {
			...
			flowLogCollectorTargetPrototypeModel := &vpcv1.FlowLogCollectorTargetPrototypeNetworkInterfaceIdentityNetworkInterfaceIdentityByID{
	...
	Describe(`RemoveInstanceNetworkInterfaceIP - Unbind a reserved IP from a network interface`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`RemoveInstanceNetworkInterfaceIP(removeInstanceNetworkInterfaceIPOptions *RemoveInstanceNetworkInterfaceIPOptions)`, func() {

			removeInstanceNetworkInterfaceIPOptions := &vpcv1.RemoveInstanceNetworkInterfaceIPOptions{
				InstanceID:         core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				ID:                 core.StringPtr("testString"),
			}

			response, err := vpcService.RemoveInstanceNetworkInterfaceIP(removeInstanceNetworkInterfaceIPOptions)
	...
	Describe(`RemoveBareMetalServerNetworkInterfaceIP - Unbind a reserved IP from a network interface`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`RemoveBareMetalServerNetworkInterfaceIP(removeBareMetalServerNetworkInterfaceIPOptions *RemoveBareMetalServerNetworkInterfaceIPOptions)`, func() {

			removeBareMetalServerNetworkInterfaceIPOptions := &vpcv1.RemoveBareMetalServerNetworkInterfaceIPOptions{
				BareMetalServerID:  core.StringPtr("testString"),
				NetworkInterfaceID: core.StringPtr("testString"),
				ID:                 core.StringPtr("testString"),
			}

			response, err := vpcService.RemoveBareMetalServerNetworkInterfaceIP(removeBareMetalServerNetworkInterfaceIPOptions)
	...
	Describe(`DeleteBackupPolicyPlan - Delete a backup policy plan`, func() {
		BeforeEach(func() {
			shouldSkipTest()
		})
		It(`DeleteBackupPolicyPlan(deleteBackupPolicyPlanOptions *DeleteBackupPolicyPlanOptions)`, func() {
